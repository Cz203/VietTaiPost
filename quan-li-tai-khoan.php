                                            ...
                                            <div class="mb-3">
                                                ...
                                                <div class="input-group">
                                                    ...
                                                    <div class="input-group-append">
                                                        <button class="btn btn-primary" type="button" id="openModalBtn">
                                                            <?php
                                            ...
                                            <div class="mb-3">
                                                ...
                                                <div class="input-group">
                                                    <input value="<?= htmlspecialchars(string: $so_dien_thoai) ?>"
                                                        ...
                                                        oninput="toggleSaveButtonSDT()" onblur="validatePhoneNumber()">
                                                        ...
                                                        <div class="modal-body">
                                                            <form action="quan-li-tai-khoan.php" method="POST">
                                                                <div
                                                                    class="form-group icon-addon addon-right text-left">
                                                                    <input class="form-control mb-0"
                                                                        name="password_for_sdt" id="password_for_sdt"
                                    ...
                                    <div class="row mb-3">
                                        ...
                                        <div class="form-group col-md-6 row justify-content-end ng-star-inserted">
                                            <button class="btn btnviettelCmt btnExcelCmt mr-3"><svg fill="none"
                                                ...
                                                class="btn btnviettelCmt btnSampleCmt mr-3"><svg fill="none" height="20"
                                                    ...
                                                    <path
                                                        ...
                                                        stroke="#3B7CEC" stroke-linecap="round" stroke-linejoin="round"
                                                ...
                                                class="btnAction btn btnviettelCmt btnAddCmt"><svg fill="none"
                                                    ...
                                                    <path
                                                        ...
                                                        stroke="#EE0033" stroke-linecap="round" stroke-linejoin="round"
                                                        stroke-width="1.5"></path>
            ...
            <div class="modal-dialog">
                <div class="modal-content">
                    ...
                    <div class="modal-footer">
                        <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Duy trì đăng
                            nhập</button>
                        <button type="button" class="btn btn-danger"
                            onclick="window.location.href='../../logout.php'">Đăng
                            xuất</button>
                    </div>
                </div>
            </div>
