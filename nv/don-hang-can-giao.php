...
<div class="container px-4 pb-5 card border rounded-4 mt-5">
        <h3 class="mt-4">Danh sách đơn hàng được trong bưu cục của bạn</h3>
                            ...
                            <ul class="dropdown-menu">
                                <li>
                                    <form method="post" class="d-inline">
                                        ...
                                        <button type="submit" class="dropdown-item">Xác nhận đã lấy đơn hàng</button>
                                    </form>
                                </li>
                                <li>
        ...
        <h3 class="mt-4">Danh sách đơn hàng cần giao của bạn</h3>
        <table class="table table-bordered table-hover mt-3">
            <thead class="table-light">
                <tr>
                    <th>Mã ĐH</th>
                            ...
                            <ul class="dropdown-menu">
                                <li>
                                    <form method="post" class="d-inline">
                                        ...
                                        <button type="submit" class="dropdown-item">Xác nhận đã đem về bưu cục</button>
                                    </form>
                                </li>
                            </ul>
                        </div>
