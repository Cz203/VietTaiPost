...
$toName = 'Khách hàng';
$subject = 'Đơn hàng cuả bạn đã được giao';
...
if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['hanh_dong'], $_POST['ma_don'])) {
    ...
    $body = '<!DOCTYPE html>
            ...
            <head>
            <meta charset="UTF-8" />
            <title>Đơn hàng ' . $ma_don . ' của bạn đã được giao!</title>
            </head>
            ...
            <table cellpadding="0" cellspacing="0" border="0" width="100%" style="background:#f4f4f4; padding: 20px 0;">
                ...
                <td align="center">
                    ...
                    <tr>
                        ...
                        <h2 style="color:#007bff;">Đơn hàng ' . $ma_don . ' của bạn đã được giao thành công!</h2>
                        <p>Cảm ơn bạn đã tin tưởng sử dụng Viettaipost.</p>
    ...
    if ($hanh_dong === 'lay_don_hang') {
        ...
        $toEmail = $donhang->layEmailKhachHangTheoMaDon($ma_don);
                                ...
                                <ul class="dropdown-menu">
                                    <li>
                                        <form method="post" class="d-inline">
                                            ...
                                            <button type="submit" class="dropdown-item">Xác nhận đã giao thành
                                                công</button>
                                        </form>
                                    </li>
                                    <li>
                                    ...
                                    <li>
                                        <form method="post" class="d-inline">
                                            ...
                                            <button type="submit" class="dropdown-item text-primary">Trả về bưu
                                                cục</button>
                                        </form>
                                    </li>
                                </ul>
